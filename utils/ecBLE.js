...
const ecGattServerUUIDOption1 = '0000FF00-0000-1000-8000-00805F9B34FB'
...
const ecGattCharacteristicWriteUUIDOption1 = '0000FF02-0000-1000-8000-00805F9B34FB'
// const ecGattCharacteristicWriteUUIDOption2 = 'FFF2'
const ecGattCharacteristicWriteUUIDOption2 = 'FF02'
...
const _createBLEConnection = () => {
    return new Promise(function (resolve, reject) {
        wx.createBLEConnection({
            ...
            fail(res) {
                console.log(`😂 _createBLEConnection fail`);
